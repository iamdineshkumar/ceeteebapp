...
<div class="form-group">
    ...
    <select name="company_id" id="company" class="form-control" onchange="triggerBranch(this.value);" required>
...
<div class="form-group">
    ...
    <input type="number" name='mobile' class="form-control" id="mobile"
        value="{{ isset($worker) ? $worker->mobile : '' }}" placeholder="Enter Mobile number" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="date" name='dob' class="form-control" id="dob"
        value="{{ isset($worker) ? $worker->dob : '' }}" required min="1900-01-01" max="{{ date('Y-m-d') }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <select name='id_proof_type' class="form-control" id='id_proof' required>
...
<div class="form-group">
    ...
    <input type="text" name='bank_account_no' class="form-control" id="bank_account_no"
        value="{{ isset($worker) ? $worker->bank_account_no : '' }}" placeholder="Enter Bank Account Number" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name='ifsc' class="form-control" id="ifsc"
        value="{{ isset($worker) ? $worker->ifsc : '' }}" placeholder="Enter IFSC Code" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <select name='contractor_id' class="form-control" id='contarctor' required>
