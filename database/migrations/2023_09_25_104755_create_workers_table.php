...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('workers', function (Blueprint $table) {
            ...
            $table->string('labour_classification')->charset('utf8mb3')->collation('utf8mb3_general_ci');
            ...
            $table->integer('contractor_id')->charset('utf8mb3')->collation('utf8mb3_general_ci');
            ...
            $table->string('statusDoneBy')->nullable();
